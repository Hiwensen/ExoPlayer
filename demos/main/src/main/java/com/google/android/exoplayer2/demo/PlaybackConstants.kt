...
val AD_POSITION_SECONDS = listOf(495L, 723L, 998L, 1267L, 1432L, 1615L, 1940L, 2259L, 2769L, 2971L, 3373L, 3604L, 3809L, 4124L, 4505L, 4747L, 4938L, 5211L, 5711L, 6042L, 6576L, 6877L)
